        ...
        <form action="article.php" method="post">
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <?php
                        $req="SELECT nomArticleFR,img FROM article NATURAL JOIN image LIMIT 3";
                        $x=0;
                        $req=$dbh->query($req);
                            ...
                            if($x==0) {
                                echo "<div class='item active'>";
                                    ...
                                    echo "<div class='carousel-caption'>";
                                        echo "<h6>".$ligne[0]."</h6>";
                                        echo "<p><button class='btn btn-md btn-primary' type='submit' name='ArtName' value='".$ligne[0]."'>En savoir +</button></p>";
                                    echo "</div>
                                </div>";
                                $x +=1;
                            }
            ...
            <div class="container container-home" >
                <h2>Site du patrimoine mondial</h2>
                <img class="img-responsive center-block"src="../image/carte.png"></img>
                <h2>ARTICLES</h2>
                <div class="container">
                    <div class="media-container-row">
                        <?php
                            $req2 = "SELECT nomArticleFR,descArtFR,imgMin FROM article NATURAL JOIN image LIMIT 6";
                            $req2=$dbh->query($req2);
                                ...
                                echo"<div class='card p-3 col-12 col-md-6 col-lg-4'>
                                    <div class='card-wrapper'>
                                        ...
                                        <div class='card-box'>
                                            ...
                                            echo "<p><button class='btn btn-md btn-primary' type='submit'  name='ArtName' value='".$ligne2[0]."'>En savoir +</button></p>
                                        </div>
                                    </div>
                                </div>";
                            }
