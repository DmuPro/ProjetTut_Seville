                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="myNavbar">
                        <ul class="nav navbar-nav">
                            <li class="<?php active('index.php');?>"><a href="index.php">Accueil</a></li>
                            <li class="<?php active('architecture.php');?>"><a href="architecture.php">Architecture</a></li>
                            <li class="<?php active('voyageurs.php');?>"><a href="voyageurs.php ">Voyageurs</a></li>
                            <li class="<?php active('timeline.php');?>"><a href="timeline.php">Chronologie</a></li>
                        </ul>
